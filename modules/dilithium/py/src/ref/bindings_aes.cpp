...
extern "C" int pqcrystals_dilithium2aes_ref(
    uint8_t *sm
  , size_t *smlen
  , const uint8_t *m
  , size_t mlen
...
extern "C" int pqcrystals_dilithium2aes_ref_open(
    uint8_t *m
  , size_t *mlen
  , const uint8_t *sm
  , size_t smlen
...
extern "C" int pqcrystals_dilithium2aes_ref_keypair_p()
{
    int ret = pqcrystals_dilithium2aes_ref_keypair(pk, sk);
...
extern "C" char const* pqcrystals_dilithium2aes_ref_p(
    char const *m
  , int mlen
){
    if (sm)
...
extern "C" char const* pqcrystals_dilithium2aes_ref_open_p(
    char const *m
  , int mlen
)
{
    ...
    int status = pqcrystals_dilithium2aes_ref_open(sm, &mmlen, sm_base58, mlen, pk);
    sm[mmlen] = 0;
...
PYBIND11_MODULE(pydilithium_aes, m) {
  ...
  m.def("pqcrystals_dilithium2_ref_keypair", &pqcrystals_dilithium2aes_ref_keypair_p, R"doc(
  ...
  m.def("pqcrystals_dilithium2_ref", &pqcrystals_dilithium2aes_ref_p, R"doc(
  ...
  m.def("pqcrystals_dilithium2_ref_open", &pqcrystals_dilithium2aes_ref_open_p, R"doc(
